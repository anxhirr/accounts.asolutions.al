...
import { SelectProductType } from "./validation";
...
export const products = pgTable("products", {
  name: text("name").notNull(),
  // You can use { mode: "bigint" } if numbers are exceeding js number limitations
  initialStock: bigint("initialStock", { mode: "number" }).notNull(),
  // You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const plan = pgTable("plan", {
  ...
  memberLimit: smallint("memberLimit").notNull(),
  yearlyPrice: numeric("yearlyPrice").notNull(),
  name: text("name").notNull(),
  productsLimit: smallint("productsLimit").notNull(),
});
...
export const subscription = pgTable("subscription", {
  ...
  billingPeriod: billingPeriod("billingPeriod").notNull(),
});
